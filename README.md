...
2. A small library I made for the hardware I used: the N20 motors+their encoders (which required polling for the encoders), the gyro, the servo, and the camera (just a pi camera module 3)
