...
### [FRC1155 Codebase](https://github.com/SciBorgs/Reefscape-2025)
My [FRC Team's](https://github.com/SciBorgs) codebase for the 2025 FRC game, Reefscape. 
...
### [NeuroKairos](https://github.com/SjulsonLab/irig_unix_timecodes)
...
### [Whiteboard Eraser](https://github.com/Unclesdad/whiteboard-eraser)
...
### [CharlieGPT](https://github.com/Unclesdad/CharlieGPT)
A codebase to fine-tune a Large Language Model on your messages. 
I fine-tuned it on mine, by using [DiscordChatExporter](https://github.com/Tyrrrz/DiscordChatExporter) for discord messages, and requesting a copy of my data from Meta for Instagram messages.
...
### [Mind-controlled drone](https://github.com/DoubleABattery08/EEG-EMG-Transceiver-Drone)
...
You can find more stuff by looking through [my profile](https://github.com/Unclesdad)!
